...
/**
 * Will return the path and rtmcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'rtmcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'rtmcore-node.json'))
  };
}

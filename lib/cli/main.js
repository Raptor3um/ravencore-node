...
var rtmcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = rtmcorenode.version;
  var create = rtmcorenode.scaffold.create;
  var add = rtmcorenode.scaffold.add;
  var start = rtmcorenode.scaffold.start;
  var remove = rtmcorenode.scaffold.remove;
  var callMethod = rtmcorenode.scaffold.callMethod;
  var findConfig = rtmcorenode.scaffold.findConfig;
  var defaultConfig = rtmcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Raptoreum database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `rtmcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ rtmcore-node add wallet-service');
      console.log('    $ rtmcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ rtmcore-node remove wallet-service');
      console.log('    $ rtmcore-node remove insight-api');
      console.log();
    });

...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    raptoreumd.spawn.datadir.should.equal(home + '/.raptor');
    raptoreumd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/raptoreumd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.raptoreumd.spawn.datadir.should.equal('./data2');
  });
});
